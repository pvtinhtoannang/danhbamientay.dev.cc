...
/* C:\Program Files (x86)\Ampps\www\octobercms\danhbamientay.dev.cc/plugins/toannang/componentbuilder/components/pvtinhdbmientaysidebaraccount/default.htm */
class __TwigTemplate_c79dee7588fbd86d06d654b2a08ce5af8ab6c70b137f3db65b2aca8f693b1638 extends \Twig\Template
{
    private $source;
    ...
    <div class=\"form-group avatar-form\">
        ...
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "avatar", [], "any", false, false, false, 10), "getThumb", [0 => 200, 1 => 200, 2 => [0 => "mode", 1 => "crop"]], "method", false, false, false, 10), "html", null, true);
        echo "')\">
    ...
    <ul class=\"list-user\">
        <li class=\"text-dark\"><i class=\"fa fa-user\"></i><a href=\"/tai-khoan\" class=\"text-dark\" title=\"Tài khoản\">Trang
            cá nhân</a></li>
        <li class=\"text-dark\"><i class=\"fa fa-plus\"></i><a href=\"/dang-tin\" class=\"text-dark\" title=\"Đăng tin\">Đăng
            tin</a></li>
        <li class=\"text-dark\"><i class=\"fa fa-key\"></i><a href=\"/doi-mat-khau\" class=\"text-dark\" title=\"Đổi mật khẩu\">Đổi
            mật khẩu</a></li>
        <li class=\"text-dark\"><i class=\"fa fa-list\"></i><a href=\"/danh-sach-tin-dang\" class=\"text-dark\"
                                                           title=\"Danh sách tin đăng\">Danh sách tin đăng</a></li>
        <li class=\"text-dark\"><i class=\"fa fa-sign-out\"></i><a data-request=\"onLogout\" href=\"/dang-xuat\"
                                                               class=\"text-dark\" title=\"Đăng xuất\">Đăng xuất</a></li>
    </ul>
</div>   ";
    }
    ...
    {
        return "C:\\Program Files (x86)\\Ampps\\www\\octobercms\\danhbamientay.dev.cc/plugins/toannang/componentbuilder/components/pvtinhdbmientaysidebaraccount/default.htm";
    }
    ...
    {
        return array (  72 => 15,  64 => 10,  59 => 8,  55 => 7,  51 => 6,  46 => 4,  42 => 3,  38 => 2,  35 => 1,);
    }
...
</div>   ", "C:\\Program Files (x86)\\Ampps\\www\\octobercms\\danhbamientay.dev.cc/plugins/toannang/componentbuilder/components/pvtinhdbmientaysidebaraccount/default.htm", "");
    }
}
