...
/* C:\Program Files (x86)\Ampps\www\octobercms\danhbamientay.dev.cc/plugins/toannang/componentbuilder/components/pvtinhdbmientayaccount/default.htm */
class __TwigTemplate_ed7162c3304ce919d7c1749ddec68a3c16e47b4f25f9a99d77a14190acd13842 extends \Twig\Template
{
    private $source;
...
\t\t\t\t<input type=\"email\" name=\"email\" value=\"";
        // line 15
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "profile", [], "any", false, false, false, 15), "email", [], "any", false, false, false, 15), "html", null, true);
...
\t\t\t\t<input type=\"text\" name=\"website\" value=\"";
        // line 23
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "profile", [], "any", false, false, false, 23), "website", [], "any", false, false, false, 23), "html", null, true);
...
\t\t\t\t<input type=\"text\" name=\"phone_number\" value=\"";
        // line 30
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "profile", [], "any", false, false, false, 30), "phone_number", [], "any", false, false, false, 30), "html", null, true);
...
\t\t\t\t<input type=\"text\" name=\"address\" value=\"";
        // line 37
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "profile", [], "any", false, false, false, 37), "address", [], "any", false, false, false, 37), "html", null, true);
...
\t\t\t\t<textarea name=\"bio\" id=\"bio\" class=\"input-dbmt\" rows=\"10\" placeholder=\"Mô tả doanh nghiệp của bạn\">";
        // line 44
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "profile", [], "any", false, false, false, 44), "bio", [], "any", false, false, false, 44), "html", null, true);
        echo "</textarea>
...
";
    ...
    {
        return "C:\\Program Files (x86)\\Ampps\\www\\octobercms\\danhbamientay.dev.cc/plugins/toannang/componentbuilder/components/pvtinhdbmientayaccount/default.htm";
    }
...
\t\t\t<div class=\"form-group\">
\t\t\t\t<label for=\"email\">Email: <span class=\"fa fa-question-circle text-primary\" data-toggle=\"tooltip\" title=\"Bạn nên nhập chính xác email. Email dùng để đăng nhập vào website cũng như giúp bạn lấy lại mật khẩu khi cần.\"></span></label>
\t\t\t\t<input type=\"email\" name=\"email\" value=\"{{ user.profile.email }}\" class=\"input-dbmt\" placeholder=\"Nhập email của bạn: \">
\t\t\t\t<span class=\"error-label\" data-validate-for=\"email\"></span>
\t\t\t</div>
\t\t</div>
...
\t\t\t<div class=\"form-group\">
\t\t\t\t<label for=\"website\">Website: <span class=\"fa fa-question-circle text-primary\" data-toggle=\"tooltip\" title=\"Mọi người có thể tìm tới và tăng lượt truy cập cho website của bạn\"></span></label>
\t\t\t\t<input type=\"text\" name=\"website\" value=\"{{ user.profile.website }}\" class=\"input-dbmt\" placeholder=\"Nhập website của bạn \">
\t\t\t\t<span class=\"error-label\" data-validate-for=\"website\"></span>
\t\t\t</div>
\t\t</div>
\t\t<div class=\"col-xs-12 col-sm-6 col-md-6\">
\t\t\t<div class=\"form-group\">
\t\t\t\t<label for=\"phone_number\">Số điện thoại: <span class=\"fa fa-question-circle text-primary\" data-toggle=\"tooltip\" title=\"Số điện thoại giúp mọi người có thể liên lạc đến bạn\"></span></label>
\t\t\t\t<input type=\"text\" name=\"phone_number\" value=\"{{ user.profile.phone_number }}\" class=\"input-dbmt\" placeholder=\"Nhập số điện thoại của bạn: \">
\t\t\t\t<span class=\"error-label\" data-validate-for=\"phone_number\"></span>
\t\t\t</div>
\t\t</div>
\t\t<div class=\"col-xs-12 col-sm-12 col-md-12\">
\t\t\t<div class=\"form-group\">
\t\t\t\t<label for=\"address\">Địa chỉ: <span class=\"fa fa-question-circle text-primary\" data-toggle=\"tooltip\" title=\"Địa chỉ giúp mọi người có thể tìm đến bạn\"></span></label>
\t\t\t\t<input type=\"text\" name=\"address\" value=\"{{ user.profile.address }}\" class=\"input-dbmt\" placeholder=\"Nhập địa chỉ của bạn: \">
\t\t\t</div>
\t\t</div>
\t\t
\t\t<div class=\"col-xs-12 col-sm-12 col-md-12\">
\t\t\t<div class=\"form-group\">
\t\t\t\t<label for=\"bio\">Mô tả doanh nghiệp: <span class=\"fa fa-question-circle text-primary\" data-toggle=\"tooltip\" title=\"Địa chỉ giúp mọi người có thể tìm đến bạn, bạn nên nhập mô tả ít nhất 200 kí tự!\"></span></label>
\t\t\t\t<textarea name=\"bio\" id=\"bio\" class=\"input-dbmt\" rows=\"10\" placeholder=\"Mô tả doanh nghiệp của bạn\">{{ user.profile.bio }}</textarea>
\t\t\t\t<span class=\"error-label\" data-validate-for=\"bio\"></span>
\t\t\t</div>
\t\t</div>
\t\t<div class=\"col-xs-12\">
...
\t</div>
{{ form_close() }}
</form>\t", "C:\\Program Files (x86)\\Ampps\\www\\octobercms\\danhbamientay.dev.cc/plugins/toannang/componentbuilder/components/pvtinhdbmientayaccount/default.htm", "");
    }
}
