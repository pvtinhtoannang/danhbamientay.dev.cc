...
\t        \t\t\t</div>
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["pagination"] ?? null), "last", [], "any", false, false, false, 90) > 1)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                echo " href=\"/tim-kiem?danh-muc=";
                echo twig_escape_filter($this->env, ($context["danhmuc"] ?? null), "html", null, true);
                echo "&keyword=";
                echo twig_escape_filter($this->env, ($context["keyword"] ?? null), "html", null, true);
                echo "&page=";
...
\t</div>
    ...
    {
        return array (  271 => 103,  262 => 98,  244 => 96,  238 => 95,  234 => 94,  229 => 91,  227 => 90,  224 => 89,  215 => 85,  210 => 82,  204 => 80,  201 => 79,  195 => 77,  192 => 76,  186 => 74,  184 => 73,  179 => 71,  175 => 69,  169 => 67,  165 => 65,  163 => 64,  159 => 63,  155 => 61,  149 => 59,  145 => 57,  143 => 56,  139 => 55,  135 => 53,  133 => 52,  122 => 50,  116 => 46,  108 => 44,  100 => 42,  98 => 41,  90 => 40,  85 => 37,  81 => 36,  73 => 31,  56 => 17,  45 => 9,  35 => 1,);
    }
                    ...
                    <div class=\"col-xs-12\">
                        <div class=\"pagination\"> 
                          ...
                          {% for i in 1..pagination.last  %} 
                            <a {% if pagination.current == i %} class=\"active\" {% endif %} href=\"/tim-kiem?danh-muc={{ danhmuc }}&keyword={{ keyword }}&page={{ i }}\">{{ i }} </a>
                          {% endfor %}
