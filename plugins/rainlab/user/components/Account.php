    ...
    public function onSignin()
    {
        try {
            ...
            $messages = [
                ...
                'login.between' => 'Tài khoản hoặc email phải có độ dài từ 6 đến 225 kí tự!',
                'login.email' => 'Email đăng nhập không hợp lệ!',
    ...
    public function onRegister()
    {
        try {
            ...
            $messages = [
                ...
                'username.between' => 'Tài khoản phải có độ dài từ 6 đến 225 kí tự!',
                'password.required' => 'Vui lòng nhập mật khẩu!',
                'password.confirmed' => 'Xác nhận mật khẩu chưa đúng!',
                'password.between' => 'Mật khẩu phải có độ dài từ 8 đến 22 kí tự!'
            ];
            $validation = Validator::make($data, $rules, $messages);
            if ($validation->fails()) {
                throw new ValidationException($validation);
